...
insert into Fortune (user_id, message, date) values (1, 'Testing123', current_time);
insert into Fortune (user_id, message, date) values (2, 'Testing2', current_time);
insert into Fortune (user_id, message, date) values (3, 'Testing3', current_time);
